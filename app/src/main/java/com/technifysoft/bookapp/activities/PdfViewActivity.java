...
import com.github.barteksc.pdfviewer.compressor.DeflateFile;
...
public class PdfViewActivity extends AppCompatActivity {
    ...
    private void loadBookFromUrl(String pdfUrl) throws DataFormatException, IOException {
        Log.d(TAG, "loadBookFromUrl: Get PDF from storage");
        StorageReference reference = FirebaseStorage.getInstance().getReferenceFromUrl(pdfUrl);
        //path of pdf in firebase storage
        String filePathAndName = "Books/" +System.currentTimeMillis();
        //decompression of files
        DeflateFile.decompressFile(pdfUrl, filePathAndName);
